...
echo "$window_list" | sed "s/firefox//g" | sed "s/Alacritty//g" | sed "s/Steam//g" | sed "s/Ripcord//g" | sed "s/FreeTube//g" | sed "s/discord//g" | sed "s/RPCS3//g" | sed "s/Electron/💩/g"
